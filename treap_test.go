...
func TestUnion(t *testing.T) {
	...
	combined := part1.Union(part2, intComparer[int], false)
	all := ToTreap(input)
...
func TestIntersection(t *testing.T) {
	...
	intersection := set1.Intersection(set2, intComparer[int])
...
func TestDiff(t *testing.T) {
	...
	diff := set1.Diff(set2, intComparer[int])
...
func BenchmarkInsert(b *testing.B) {
	...
	for kk := 0; kk < b.N; kk++ {
		...
		x.Union(insert, intComparer[int], false)
	}
}
...
func BenchmarkIntersection(b *testing.B) {
	...
	for kk := 0; kk < b.N; kk++ {
		set1.Intersection(set2, intComparer[int])
	}
}
...
func BenchmarkUnion(b *testing.B) {
	...
	for kk := 0; kk < b.N; kk++ {
		part1.Union(part2, intComparer[int], false)
	}
}
...
func BenchmarkDiff(b *testing.B) {
	...
	for kk := 0; kk < b.N; kk++ {
		set1.Diff(set2, intComparer[int])
	}
}

func ToTreap[T constraints.Integer](v []T) *container.Treap[T] {
	var t *container.Treap[T]
	for _, elt := range v {
		priority := rand.Intn(10000000)
		t = t.Union(&container.Treap[T]{elt, priority, nil, nil}, intComparer[T], false)
	}
	return t
}

func ToArray[T constraints.Integer](n *container.Treap[T]) []T {
	if n == nil {
		return nil
	}
	l, r := ToArray(n.Left), ToArray(n.Right)
	l = append([]T(nil), l...)
	return append(append(l, n.Value), r...)
}
